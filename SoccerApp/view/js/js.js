...
function toggle() {
    ...
    if(localStorage.getItem('bg') !== null) {
        ...
        if(localStorage.getItem('bg') === "none") {
            document.body.style.backgroundColor = 'rgb(51,182,122)';
            dark.checked = false;
        }
    }
    
    //  for backgroundImage1
    if(localStorage.getItem('background-image') !== null) {
        if(localStorage.getItem('background-image') === 'url("view/images/soccer1.png")') {
            document.body.style.backgroundImage = localStorage.getItem('background-image');
            bgImage.checked = true;
        } 
        if(localStorage.getItem('background-image') === "none") {
            document.body.style.backgroundImage = "none";
            bgImage.checked = false;
        }
    } else {
        document.body.style.backgroundImage = "none";
    }
    ...
    //  for font type
    if(localStorage.getItem('change-font') !== null) {
        var changeFont = document.getElementById("changeFont");
        if(localStorage.getItem('change-font') === "'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif") {
            document.body.style.fontFamily = localStorage.getItem('change-font');
            changeFont.checked = true;
        } 
        if(localStorage.getItem('change-font') === "none") {
    ...
    if(localStorage.getItem('change-logo') !== null) {
        ...
        if(localStorage.getItem('change-logo') === 'view/images/logo2.png') {
            ...
            changelogo.checked = true;
        } 
        if(localStorage.getItem('change-logo') === "none") {
            document.getElementById("top-logo").setAttribute("src", "view/images/logo.png");
            changelogo.checked = false;
        }
    }

    // for changing footer color
    if(localStorage.getItem('change-color') !== null) {
        var changeColor = document.getElementById("changeColor");
        if(localStorage.getItem('change-color') === 'grey') {
            document.getElementById("app-foot").style.backgroundColor = "grey";

            changeColor.checked = true;
        } 
        if(localStorage.getItem('change-color') === "none") {
            document.body.style.backgroundImage = "none";
...
function switchBgImg(y) {
    if(y.checked == true) {
        ...
        localStorage.setItem('background-image', "none")
        document.body.style.backgroundImage = "none";
    }
}
...
function changeFont(font) {
    localStorage.removeItem("change-font");
    if(font.checked == true) {
        if(localStorage.getItem('change-font') == null) {
            localStorage.setItem('change-font', "'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif")
            var font = localStorage.getItem('change-font');
        ...
        localStorage.setItem('change-font', "none")
        document.body.style.fontFamily = "";
    }
